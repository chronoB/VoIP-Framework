...
// class to bind portaudio for easier use 
...
//constant that will be thrown if a error in the init occurs
...
public:
	...
	// read block interleaved for wasapi devices with two channels
